<div class="container bg-white rounded shadow-sm p-4 mt-4" style="min-height: 80vh;">
  <h4 class="mb-4">Daftar Kehadiran: <?php echo $_SESSION['username']; ?></h4>
  <div class="table-responsive">
        ...
        <tr>
          ...
          <?php 
            if ($d['dikonfirmasi_oleh'] == '-'){
              echo "<td><button class='btn btn-warning text-white'><i class='bi bi-clock'></i> &nbsp;Belum dikonfirmasi</button></td>";
            } else {
    ...
    <?php if($halamanAktif > 1): ?>
      <a href="?halaman=<?= $halamanAktif - 1 ?>"><i class="bi bi-arrow-left-circle"></i></a>
    <?php endif; ?>
    ...
    <?php if($halamanAktif < $jumlahHalaman): ?>
      <a href="?halaman=<?= $halamanAktif + 1 ?>"><i class="bi bi-arrow-right-circle"></i></a>
    <?php endif; ?>
  </div>
</div>